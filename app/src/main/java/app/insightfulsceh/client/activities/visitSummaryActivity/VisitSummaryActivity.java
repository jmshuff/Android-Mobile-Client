package app.insightfulsceh.client.activities.visitSummaryActivity;
...
//we can remove by data binding
        ...
        card_priority=findViewById(R.id.flageddetails);
        ...
        if(Shroff){
            ...
            card_priority.setVisibility(View.GONE);
        }
