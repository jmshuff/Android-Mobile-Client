package app.insightfulsceh.client.activities.homeActivity;
...
import app.insightfulsceh.client.activities.loginActivity.LoginActivity;
import app.insightfulsceh.client.activities.privacyNoticeActivity.PrivacyNotice_Activity;
import app.insightfulsceh.client.activities.searchPatientActivity.SearchPatientActivity;
import app.insightfulsceh.client.activities.settingsActivity.SettingsActivity;
import app.insightfulsceh.client.activities.todayPatientActivity.TodayPatientActivity;
import app.insightfulsceh.client.activities.uploadImageActivity.uploadImageActivity;
import app.insightfulsceh.client.app.AppConstants;
import app.insightfulsceh.client.app.IntelehealthApplication;
import app.insightfulsceh.client.models.CheckAppUpdateRes;
import app.insightfulsceh.client.models.DownloadMindMapRes;
import app.insightfulsceh.client.networkApiCalls.ApiClient;
import app.insightfulsceh.client.networkApiCalls.ApiInterface;
import app.insightfulsceh.client.syncModule.SyncUtils;
import app.insightfulsceh.client.utilities.ConfigUtils;
import app.insightfulsceh.client.utilities.DownloadMindMaps;
...
import app.insightfulsceh.client.utilities.OfflineLogin;
            ...
            public void onClick(View V){
                if (NetworkConnection.isOnline(HomeActivity.this)) {
                    ...
                    if (!sessionManager.getLicenseKey().isEmpty()) {
                        ...
                        IntelehealthApplication.setAlertDialogCustomTheme(HomeActivity.this, builderDialog);
