package app.insightfulsceh.client.knowledgeEngine;
...
import app.insightfulsceh.client.utilities.InputFilterMinMax;
...
import app.insightfulsceh.client.activities.complaintNodeActivity.CustomArrayAdapter;
...
public class Node implements Serializable {
    ...
    public Node(JSONObject jsonNode) {
        try {
            ...
            this.display_tamil = jsonNode.optString("display-or");
...
//        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
    ...
    */
    ...
    public void setDisplay_tamil(String display_tamil) {this.display_tamil = display_tamil; }
