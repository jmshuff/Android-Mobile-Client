package app.insightfulsceh.client.database.dao;
...
import app.insightfulsceh.client.models.uploadImage;
import app.insightfulsceh.client.networkApiCalls.AzureNetworkClient;
import app.insightfulsceh.client.networkApiCalls.AzureUploadAPI;
