package app.insightfuleye.client.database;
...
public class InteleHealthDatabaseHelper extends SQLiteOpenHelper {
    ...
    public void uuidInsert(SQLiteDatabase db) {
        ...
        if (sessionManager.isFirstTimeLaunched()) {
            ...
            db.execSQL("INSERT OR REPLACE INTO tbl_uuid_dictionary (uuid,name) VALUES('e80190f4-374f-4d1b-b52d-b315328618b7','ENCOUNTER_PHYSICAL_EXAM')");
            ...
            db.execSQL("INSERT OR REPLACE INTO tbl_uuid_dictionary (uuid,name) VALUES('00784346-7f86-43ea-a40b-608d6deacfab','ATTRIBUTE_EYE_CAMP_ID')");
            ...
            db.execSQL("INSERT OR REPLACE INTO tbl_uuid_dictionary (uuid,name) VALUES('809a1df6-8cc6-4d2c-92e7-00f7468f496e','ENCOUNTER_FOLLOWUP')");
            db.execSQL("INSERT OR REPLACE INTO tbl_uuid_dictionary (uuid,name) VALUES('36d207d6-bee7-4b3e-9196-7d053c6eddce','COMMENTS')");
