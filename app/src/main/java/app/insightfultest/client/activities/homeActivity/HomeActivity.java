package app.insightfultest.client.activities.homeActivity;
...
import app.insightfultest.client.activities.activePatientsActivity.ActivePatientActivity;
import app.insightfultest.client.activities.identificationActivity.IdentificationActivity;
import app.insightfultest.client.activities.loginActivity.LoginActivity;
import app.insightfultest.client.activities.privacyNoticeActivity.PrivacyNotice_Activity;
import app.insightfultest.client.activities.searchPatientActivity.SearchPatientActivity;
import app.insightfultest.client.activities.settingsActivity.SettingsActivity;
import app.insightfultest.client.activities.todayPatientActivity.TodayPatientActivity;
import app.insightfultest.client.app.AppConstants;
import app.insightfultest.client.app.IntelehealthApplication;
import app.insightfultest.client.models.CheckAppUpdateRes;
import app.insightfultest.client.models.DownloadMindMapRes;
import app.insightfultest.client.networkApiCalls.ApiClient;
import app.insightfultest.client.networkApiCalls.ApiInterface;
import app.insightfultest.client.syncModule.SyncUtils;
import app.insightfultest.client.utilities.ConfigUtils;
import app.insightfultest.client.utilities.DownloadMindMaps;
...
import app.insightfultest.client.utilities.OfflineLogin;
import app.insightfultest.client.utilities.SessionManager;
import app.insightfultest.client.widget.materialprogressbar.CustomProgressDialog;
